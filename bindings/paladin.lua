...
local palaBase = {
	...
	ctrl = {
		...
		['C'] 	= 'm|/use 15' -- Use cloak slot (legendary cloak - BFA)
	}
}
...
local holy = {
	...
	[9] 	= 'm|/cast [talent:5/2] Holy Avenger', -- Lvl 90 talent
	['`'] 	= 'm|/cast Avenging Wrath',
	...
	shift = {
		...
		[7] 	= 's|Aura Mastery',
		[9]		= "m|/cast [talent:2/3] Holy Prism"
